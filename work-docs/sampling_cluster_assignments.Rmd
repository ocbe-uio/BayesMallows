...
```{r}
n_samples <- 10000
samples <- replicate(n_samples, draw_cluster_assignments(prob))
table(samples) / n_samples
```
...
```{r}
samples <- replicate(n_samples, draw_cluster_assignments_cond(probs))
table(samples) / n_samples
```
...
```{r}
samples <- replicate(n_samples, draw_cluster_assignments_sylvia(probs))
table(samples) / n_samples
```
