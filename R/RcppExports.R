...
rank_dist_sum <- function(rankings, rho, metric) {
    .Call(`_BayesMallows_rank_dist_sum`, rankings, rho, metric)
}

rank_dist_vec <- function(rankings, rho, metric) {
    .Call(`_BayesMallows_rank_dist_vec`, rankings, rho, metric)
}
