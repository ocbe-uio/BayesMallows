...
#' @description Function to perform Metropolis-Hastings for new alpha under the Mallows model
...
#' @author Anja Stein
#' #ASK: Ask Anja for example to aid translation to C++
#' #TODO wait for Anja's update on function before translating
#' @export
