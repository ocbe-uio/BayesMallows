...
#'
#' @param rankings A matrix of ranked items. See \code{\link{create_ranking}} if you
#'   have an ordered set of items that needs to be converted to rankings. If
#'   \code{preferences} is provided, \code{rankings} is an optional initial value of the
#'   rankings, generated by \code{\link{generate_initial_ranking}}.
#' @param preferences A dataframe with the transitive closure of pairwise comparisons. If
...
#' @param leap_size Step size of the leap-and-shift proposal distribution. Defaults to
