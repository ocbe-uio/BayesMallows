...
) # FIXME: #74 trace and fix warning. Only use 1st column
...
rho_map <- compute_rho_consensus(output = test$rho_samples[,,Time+1], nmc = N, burnin = 0, C = 1, type = "MAP") # FIXME: #74 trace and fix warning. Only use 1st column
