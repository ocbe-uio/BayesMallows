...
test_that("Runs with pseudo kernel", {
  ...
  expect_equal(
    ...
    structure(c(
      1, 2, 3, 1, 3, 3, 2, 1, 1, 1, 2, 4, 2, 5, 1, 1, 3,
  ...
  expect_equal(
    smc_unif$augmented_rankings[, , 17],
    structure(c(
      1, 2, 3, 1, 3, 3, 2, 1, 1, 1, 2, 4, 2, 5, 1, 1, 3,
      3, 2, 2, 3, 5, 4, 3, 5, 2, 5, 2, 6, 3, 4, 6, 1, 4, 6, 4, 4, 4,
      5, 4, 6, 1, 5, 2, 4, 5, 1, 5, 3, 5, 5, 3, 6, 6, 2, 6, 6, 6, 4,
  ...
  expect_equal(
    ...
    structure(c(
      5, 6, 4, 6, 4, 5, 6, 6, 4, 6, 6, 5, 5, 4, 5, 5, 6,
      ...
      2, 2, 2, 3, 3, 2, 2, 3, 5, 3, 1, 2, 3, 2, 1, 2, 3, 2, 3
    ), dim = c(
      20L,
      6L
    ))
  ...
  expect_equal(
    ...
    c(
      0.300765933188255, 0.0568764980067235, 0.0649834989303742,
