...
test_that("Specific example results are OK", {
  ...
  expect_equal(
    ...
    structure(c(0.1271, 1.01988, 0.35984, 0.24885, 0.25341, 0.21513,
                0.33608, 0.19977, 0.12366, 0.45756, 0.11026, 0.07627), dim = 3:4)
  )
  expect_equal(
    round(test$ESS, 5),
    structure(c(4.14205, 8.5671, 8.39147, 8.259, 9.71963, 9.56654,
                9.88288, 9.85273, 9.63934, 9.85424, 9.92305, 9.97621, 9.88009,
                9.98684, 9.99196, 9.96685, 9.99779, 9.99769, 9.99519, 9.99277
    ), dim = c(1L, 20L))
  )
  ...
  expect_equal(rho_cp$cumprob,
               c(0.75, 0.625, 0.75, 0.875, 0.75, 0.875, 0.875, 0.625, 0.75, 1))
