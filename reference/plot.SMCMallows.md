...
- items:
  ...
  Either a vector of item names, or a vector of indices. If NULL, five
  items are selected randomly.

- ...:

  Other arguments passed to [`plot`](https://rdrr.io/r/base/plot.html)
  (not used).
