...
#> 1        1    fatty tuna    fatty tuna    fatty tuna        shrimp    fatty tuna
#> 2        2          tuna          tuna    sea urchin       sea eel    sea urchin
#> 3        3    salmon roe       sea eel    salmon roe         squid    salmon roe
#> 4        4        shrimp        shrimp          tuna           egg       sea eel
#> 5        5     tuna roll     tuna roll        shrimp    fatty tuna          tuna
#> 6        6         squid         squid         squid          tuna        shrimp
#> 7        7           egg           egg     tuna roll     tuna roll     tuna roll
#> 8        8       sea eel cucumber roll       sea eel    salmon roe         squid
#> 9        9 cucumber roll    salmon roe cucumber roll cucumber roll           egg
#> 10      10    sea urchin    sea urchin           egg    sea urchin cucumber roll
```
