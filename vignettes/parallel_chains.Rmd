...
#> 1     alpha 4.826  4.817 [4.293,5.401]    [4.297,5.410]
```
...
#> 4        rho  Item 4   12     11 [11,14]          [11,14]
#> 5        rho  Item 5    9      8  [8,10]           [8,10]
#> 6        rho  Item 6    2      2   [1,2]            [1,2]
#> 7        rho  Item 7    9      9  [8,10]           [8,10]
#> 8        rho  Item 8   12     12 [11,14]          [11,14]
...
#> 14       rho Item 14   13     13 [11,14]          [11,14]
#> 15       rho Item 15    5      5   [4,6]            [4,6]
```
...
#> 1  Cluster 1       1  Item 9 0.8937121
#> 2  Cluster 1       2  Item 6 0.9984848
#> 3  Cluster 1       3  Item 3 0.7614394
#> 4  Cluster 1       4 Item 11 0.9613636
#> 5  Cluster 1       5 Item 15 0.9419697
#> 6  Cluster 1       6 Item 10 0.9698485
#> 7  Cluster 1       7  Item 1 1.0000000
#> 8  Cluster 1       8  Item 5 0.5118939
#> 9  Cluster 1       9  Item 7 0.9307576
#> 10 Cluster 1      10 Item 13 1.0000000
#> 11 Cluster 1      11  Item 4 0.5151515
#> 12 Cluster 1      12  Item 8 0.8043182
#> 13 Cluster 1      13 Item 12 0.5931818
#> 14 Cluster 1      14 Item 14 0.9892424
...
#> 1  Cluster 1           1  Item 9   0.2281818
#> 2  Cluster 1           2  Item 6   0.2281818
#> 3  Cluster 1           3  Item 3   0.2281818
#> 4  Cluster 1           4 Item 11   0.2281818
#> 5  Cluster 1           5 Item 15   0.2281818
#> 6  Cluster 1           6 Item 10   0.2281818
#> 7  Cluster 1           7  Item 1   0.2281818
#> 8  Cluster 1           8  Item 7   0.2281818
#> 9  Cluster 1           9  Item 5   0.2281818
#> 10 Cluster 1          10 Item 13   0.2281818
#> 11 Cluster 1          11  Item 4   0.2281818
#> 12 Cluster 1          12  Item 8   0.2281818
#> 13 Cluster 1          13 Item 12   0.2281818
#> 14 Cluster 1          14 Item 14   0.2281818
#> 15 Cluster 1          15  Item 2   0.2281818
```
