...
When the name of the items have been specified in to column names of `rankings`, we can also provide these to the `items` argument. The line below plots potatoes 16 through 20.
