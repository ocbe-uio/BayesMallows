...
When data augmentation is used, `compute_mallows` saves the average acceptance rates for each assessor in the `aug_acceptance` object.
...
```{r, fig.width=6}
assess_convergence(test_run, type = "augmentation", assessors = 1:2)
```
