...
The tuning of $\alpha$ and $\rho$ can be done exactly as described above for the full potato data. It is more interesting to study the convergence of the data augmentation.

```{r}
assess_convergence(model_fit, type = "Rtilde", assessors = 1, items = 1:8)
```
