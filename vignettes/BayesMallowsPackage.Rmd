...
Let us choose 5 clusters. We can then find the cluster assignment probabilities for each assessor.
...
```{r, eval=FALSE}
cluster_assignment <- assign_cluster(models[[5]], 
