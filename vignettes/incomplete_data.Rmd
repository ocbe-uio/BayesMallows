...
We see that some of the rankings have got the value `NA`. When only one item is missing from an assessor, it is obvious what the value should be, and this is taken care of automatically by `compute_mallows`.
