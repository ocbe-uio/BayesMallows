...
## 1     alpha 1.776  1.778       95 % [1.612,1.943]    [1.597,1.934]
## 2     alpha 1.777  1.776       95 % [1.655,1.925]    [1.644,1.914]
## 3     alpha 1.785  1.783       95 % [1.671,1.896]    [1.678,1.909]
```
...
<div class="figure">
<img src="figure/plot_smc_complete-1.png" alt="Posterior distribution of scale parameter." height="4cm" />
<p class="caption">Posterior distribution of scale parameter.</p>
</div>
...
## 1            1    fatty tuna       0.615
## 2            2    salmon roe       0.615
## 3            3          tuna       0.615
## 4            4        shrimp       0.615
## 5            5       sea eel       0.615
## 6            6     tuna roll       0.615
## 7            7         squid       0.615
## 8            8    sea urchin       0.615
## 9            9           egg       0.615
## 10          10 cucumber roll       0.615
```
...
<div class="figure">
<img src="figure/smc_init_posterior-1.png" alt="Posterior distribution of scale parameter after initial run." height="4cm" />
...
<div class="figure">
<img src="figure/smc_updated_posterior-1.png" alt="Posterior distribution of scale parameter after updating the model based on new rankings." height="4cm" />
...
<div class="figure">
<img src="figure/smc_second_updated_posterior-1.png" alt="Posterior distribution of scale parameter after updating the model based on new rankings." height="4cm" />
<p class="caption">Posterior distribution of scale parameter after updating the model based on new rankings.</p>
</div>
