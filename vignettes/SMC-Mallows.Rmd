...
#> 1     alpha 1.769  1.772       95 % [1.622,1.919]    [1.616,1.918]
#> 2     alpha 1.773  1.775       95 % [1.634,1.917]    [1.624,1.914]
#> 3     alpha 1.784  1.788       95 % [1.680,1.892]    [1.682,1.892]
```
...
<div class="figure">
<img src="plot_smc_complete-1.png" alt="Posterior distribution of scale parameter." height="4cm" />
...
#> 2        2    salmon roe   0.993
#> 3        3          tuna   1.000
#> 4        4        shrimp   0.938
#> 5        5       sea eel   0.968
#> 6        6     tuna roll   0.581
#> 7        7         squid   0.966
#> 8        8    sea urchin   0.999
#> 9        9           egg   1.000
#> 10      10 cucumber roll   1.000
compute_consensus(model3, type = "MAP")
#>    map_ranking          item probability
#> 1            1    fatty tuna       0.561
#> 2            2    salmon roe       0.561
#> 3            3          tuna       0.561
#> 4            4        shrimp       0.561
#> 5            5       sea eel       0.561
#> 6            6     tuna roll       0.561
#> 7            7         squid       0.561
#> 8            8    sea urchin       0.561
#> 9            9           egg       0.561
#> 10          10 cucumber roll       0.561
```
