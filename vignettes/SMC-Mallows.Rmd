...
#> 1     alpha 1.770  1.767       95 % [1.621,1.943]    [1.612,1.943]
#> 2     alpha 1.771  1.766       95 % [1.633,1.912]    [1.634,1.914]
#> 3     alpha 1.784  1.784       95 % [1.670,1.883]    [1.682,1.897]
```
...
#> 1            1    fatty tuna       0.571
#> 2            2    salmon roe       0.571
#> 3            3          tuna       0.571
#> 4            4        shrimp       0.571
#> 5            5       sea eel       0.571
#> 6            6     tuna roll       0.571
#> 7            7         squid       0.571
#> 8            8    sea urchin       0.571
#> 9            9           egg       0.571
#> 10          10 cucumber roll       0.571
```
