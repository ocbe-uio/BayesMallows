...
#> 1     alpha 1.771  1.766 [1.601,1.919]    [1.610,1.933]
#> 2     alpha 1.776  1.775 [1.596,1.924]    [1.602,1.930]
#> 3     alpha 1.752  1.751 [1.672,1.827]    [1.678,1.832]
#> 4     alpha 1.706  1.708 [1.665,1.749]    [1.663,1.748]
```
...
#>   parameter  mean median          hpdi central_interval
#> 1     alpha 1.710  1.710 [1.667,1.755]    [1.663,1.753]
#> 2     alpha 1.706  1.708 [1.665,1.749]    [1.663,1.748]
```
...
#>      cluster ranking          item cumprob
#> 1  Cluster 1       1    fatty tuna 1.00000
#> 2  Cluster 1       2    salmon roe 0.99425
#> 3  Cluster 1       3          tuna 1.00000
#> 4  Cluster 1       4        shrimp 1.00000
#> 5  Cluster 1       5       sea eel 1.00000
#> 6  Cluster 1       6     tuna roll 0.99200
#> 7  Cluster 1       7         squid 1.00000
#> 8  Cluster 1       8    sea urchin 1.00000
#> 9  Cluster 1       9           egg 1.00000
#> 10 Cluster 1      10 cucumber roll 1.00000
```
...
mod_init <- compute_mallows(
  data = setup_rank_data(rankings = data_batch1, 
...
model2 <- update_mallows(
  mod_init, 
  new_data = setup_rank_data(rankings = data_batch2, 
                             user_ids = rownames(data_batch2)))
```
...
model3 <- update_mallows(
  mod_init, 
  new_data = setup_rank_data(rankings = data_batch3, 
                             user_ids = rownames(data_batch3)))
```
