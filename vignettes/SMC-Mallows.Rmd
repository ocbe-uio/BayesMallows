...
We begin by loading the following packages:
...
plot_rho_posterior(output = test_sample_rho,
...
test_sample_rho = smc_test$rho_samples[,,Time+1]
compute_posterior_intervals_rho(output = test_sample_rho,
                                               nmc = N, burnin = 0,
                                               verbose = FALSE)
```
...
compute_rho_consensus(output = test_sample_rho, nmc = N,
...
plot_alpha_posterior(output = test_sample_alpha, nmc = N,
                                    burnin = 0)
compute_posterior_intervals_alpha(output = test_sample_alpha,
                                                 nmc = N, burnin = 0,
                                                 verbose = FALSE)
```
...
plot_rho_posterior(output = partial_test_sample_rho, nmc = N,
                                 burnin = 0, C= 1, colnames= colnames(sushi_rankings))
plot_alpha_posterior(output = partial_test_sample_alpha, nmc = N,
                                    burnin = 0)
```
