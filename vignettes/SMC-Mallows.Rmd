...
#> 1     alpha 1.773  1.773       95 % [1.616,1.928]    [1.617,1.930]
#> 2     alpha 1.772  1.774       95 % [1.642,1.916]    [1.633,1.912]
#> 3     alpha 1.788  1.787       95 % [1.673,1.895]    [1.676,1.900]
```
...
#> 1            1    fatty tuna       0.575
#> 2            2    salmon roe       0.575
#> 3            3          tuna       0.575
#> 4            4        shrimp       0.575
#> 5            5       sea eel       0.575
#> 6            6     tuna roll       0.575
#> 7            7         squid       0.575
#> 8            8    sea urchin       0.575
#> 9            9           egg       0.575
#> 10          10 cucumber roll       0.575
```
