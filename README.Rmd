...
Updating of the posterior distribution based on new data, using sequential Monte Carlo methods, is implemented and described in a separate vignette which can be shown with the following command. The computational algorithms are described in further detail in @steinSequentialInferenceMallows2023.
