...
This package provides a general framework for analyzing rank and preference data based on the Bayesian Mallows model first described in [Vitelli et al.(2018)](http://www.jmlr.org/papers/volume18/15-481/15-481.pdf).
...
For more examples, please see the function documentation and the vignette. The latter contains an overview of the implemented methods as well as several use cases, and can be opened by the following R command:
...
The paper is accepted for publication in the R Journal, and a link will be posted here as soon as it appears online. It is identical to the package vignette mentioned above.
