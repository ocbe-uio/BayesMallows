...
Rcpp::List smc_mallows_new_item_rank(const unsigned int& n_items, arma::cube& R_obs, const std::string& metric, const int& leap_size, const unsigned int& N, const unsigned int Time, const Rcpp::Nullable<arma::vec> logz_estimate, const int& mcmc_kernel_app, Rcpp::Nullable<Rcpp::NumericVector> aug_rankings_init, Rcpp::Nullable<arma::mat> rho_samples_init, arma::vec alpha_samples_init, const double alpha, const double alpha_prop_sd, const double lambda, const double alpha_max, const std::string& aug_method, const bool verbose, const bool alpha_fixed);
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< Rcpp::Nullable<Rcpp::NumericVector> >::type aug_rankings_init(aug_rankings_initSEXP);
