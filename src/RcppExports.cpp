...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const std::string& >::type metric(metricSEXP);
    Rcpp::traits::input_parameter< const int& >::type leap_size(leap_sizeSEXP);
    rcpp_result_gen = Rcpp::wrap(smc_mallows_new_item_rank_cpp(n_items, rankings, N, Time, logz_estimate, cardinalities, mcmc_kernel_app, aug_rankings_init, rho_samples_init, alpha_samples_init, alpha, alpha_prop_sd, lambda, alpha_max, aug_method, verbose, alpha_fixed, metric, leap_size));
    return rcpp_result_gen;
END_RCPP
}
// smc_mallows_new_users_cpp
Rcpp::List smc_mallows_new_users_cpp(const arma::mat& rankings, const std::string& type, const int& n_items, const int& n_users, const int& N, int Time, const int& mcmc_kernel_app, const int& num_new_obs, const double alpha_prop_sd, const double lambda, const double alpha_max, const double alpha, const std::string& aug_method, const Rcpp::Nullable<arma::vec>& logz_estimate, const Rcpp::Nullable<arma::vec>& cardinalities, const bool verbose, const std::string& metric, const int& leap_size, Rcpp::Nullable<arma::mat> rho_init, Rcpp::Nullable<arma::vec> alpha_init);
RcppExport SEXP _BayesMallows_smc_mallows_new_users_cpp(SEXP rankingsSEXP, SEXP typeSEXP, SEXP n_itemsSEXP, SEXP n_usersSEXP, SEXP NSEXP, SEXP TimeSEXP, SEXP mcmc_kernel_appSEXP, SEXP num_new_obsSEXP, SEXP alpha_prop_sdSEXP, SEXP lambdaSEXP, SEXP alpha_maxSEXP, SEXP alphaSEXP, SEXP aug_methodSEXP, SEXP logz_estimateSEXP, SEXP cardinalitiesSEXP, SEXP verboseSEXP, SEXP metricSEXP, SEXP leap_sizeSEXP, SEXP rho_initSEXP, SEXP alpha_initSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::mat& >::type rankings(rankingsSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(smc_mallows_new_users_cpp(rankings, type, n_items, n_users, N, Time, mcmc_kernel_app, num_new_obs, alpha_prop_sd, lambda, alpha_max, alpha, aug_method, logz_estimate, cardinalities, verbose, metric, leap_size, rho_init, alpha_init));
    return rcpp_result_gen;
END_RCPP
}
