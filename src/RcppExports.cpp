...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< int >::type cluster_assignment_thinning(cluster_assignment_thinningSEXP);
    Rcpp::traits::input_parameter< bool >::type save_augmented_data(save_augmented_dataSEXP);
    Rcpp::traits::input_parameter< bool >::type verbose(verboseSEXP);
    rcpp_result_gen = Rcpp::wrap(run_mcmc(rankings, nmc, constraints, cardinalities, logz_estimate, rho_init, metric, n_clusters, include_wcd, leap_size, alpha_prop_sd, alpha_init, alpha_jump, lambda, psi, rho_thinning, aug_thinning, cluster_assignment_thinning, save_augmented_data, verbose));
    return rcpp_result_gen;
END_RCPP
}
