...
// smc_mallows_new_users_partial_Cpp
Rcpp::List smc_mallows_new_users_partial_Cpp(arma::mat& R_obs, unsigned int& n_items, std::string& metric, int& leap_size, unsigned int& N, unsigned int Time, int& mcmc_kernel_app, unsigned int& num_new_obs, double alpha_prop_sd, double lambda, double alpha_max, std::string& aug_method, const Rcpp::Nullable<arma::vec>& logz_estimate, bool verbose);
RcppExport SEXP _BayesMallows_smc_mallows_new_users_partial_Cpp(SEXP R_obsSEXP, SEXP n_itemsSEXP, SEXP metricSEXP, SEXP leap_sizeSEXP, SEXP NSEXP, SEXP TimeSEXP, SEXP mcmc_kernel_appSEXP, SEXP num_new_obsSEXP, SEXP alpha_prop_sdSEXP, SEXP lambdaSEXP, SEXP alpha_maxSEXP, SEXP aug_methodSEXP, SEXP logz_estimateSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat& >::type R_obs(R_obsSEXP);
    ...
    Rcpp::traits::input_parameter< const Rcpp::Nullable<arma::vec>& >::type logz_estimate(logz_estimateSEXP);
    Rcpp::traits::input_parameter< bool >::type verbose(verboseSEXP);
    rcpp_result_gen = Rcpp::wrap(smc_mallows_new_users_partial_Cpp(R_obs, n_items, metric, leap_size, N, Time, mcmc_kernel_app, num_new_obs, alpha_prop_sd, lambda, alpha_max, aug_method, logz_estimate, verbose));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_BayesMallows_smc_mallows_new_users_partial_Cpp", (DL_FUNC) &_BayesMallows_smc_mallows_new_users_partial_Cpp, 14},
