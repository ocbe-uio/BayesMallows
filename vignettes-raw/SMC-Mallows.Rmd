...
logz_list <- BayesMallows:::prepare_partition_function(metric = metric, n_items = n_items)
...
```{r smc_complete_analysis_heatplot, message=FALSE, warning=FALSE, fig.cap="Posterior probability for modal ranking."}
...
```{r smc_complete_alpha_analysis, message=FALSE, warning=FALSE, fig.cap="Posterior for scale parameter."}
...
```{r smc_partial_analysis_rho, message=FALSE, warning=FALSE, fig.cap="Posterior for modal ranking."}
plot(smc_partial_test, colnames = colnames(sushi_rankings), parameter = "rho")
```



```{r smc_partial_analysis_alpha, message=FALSE, warning=FALSE, fig.cap="Posterior for scale parameter."}
...
```{r smc_updated_partial_analysis_rho, message=FALSE, warning=FALSE, fig.cap="Posterior for items 4, 6, and 7."}
plot(smc_test_updated_partial, parameter = "rho", items = c(4, 6, 7))
```


```{r smc_updated_partial_analysis_alpha, message=FALSE, warning=FALSE, fig.cap="Posterior for scale parameter."}
