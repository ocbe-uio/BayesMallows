...
Based on the convergence diagnostics, and being fairly conservative, we discard the first 2,000 MCMC iterations as burn-in, and take 5,000 additional samples.

```{r}
bmm_beaches <- compute_mallows(
  data = beach_data,
  compute_options = 
    set_compute_options(nmc = 7000, burnin = 2000, save_aug = TRUE)
)
```
